...
<asp:Content ContentPlaceHolderId="PlaceHolderAdditionalPageHead" runat="server">
   ...
   <title>{solution_name}</title>
    <script type="text/javascript" src="/sites/config/Code/{solution_name}/app-entry.js"></script>
    <script type="text/javascript" src="/sites/config/Code/{solution_name}/node_modules-bundle.js"></script>
    <script type="text/javascript" src="/sites/config/Code/{solution_name}/Common.Components.js"></script>
    <script type="text/javascript" src="/sites/config/Code/{solution_name}/Common.Services.js"></script>
    <script type="text/javascript" src="/sites/config/Code/{solution_name}/main.js"></script>
